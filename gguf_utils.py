def convert_to_gguf(model, tokenizer, output_path, quantization_method="q8_0"):
    try:
        ...
        return f"Model successfully converted to GGUF format: {output_path}/unsloth-{quantization_method}.gguf", f"{output_path}/unsloth.{(quantization_method).upper()}.gguf"
